...
if($jumlah){
    ...
    echo "
    <tr>
    <th>ID Produk</th><th>Nama</th><th>ID Brand</th><th>Brand</th><th>Deskripsi</th><th>Stok</th><th>Gambar</th><th>Harga</th>
    </tr>";
    while ($row = mysqli_fetch_array($hasilselect)) {
        ...
        <td>".$row['deskripsi']."</td>
        <td>".$row['stok']."</td>
        <td><img src='data/gambar".$row['gambar']."' width='100' height='100'></td>
        <td>".$row['harga']."</td>
